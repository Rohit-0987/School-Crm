    ...
    <div className='h-screen w-5/6 ml-20 mt-5 flex'>
      ...
      <div className='w-1/2 text-center flex flex-col items-center ml-auto mt-10'>
        <h1 className='lora-font text-6xl text-mblue mt-20'>
          Welcome to <span className='text-dblue'>Learn</span>Ease!
        </h1>
        <h3 className='sedan-regular text-2xl'>
          The Premier Solution for Streamlined School Management.
        </h3>
        <h5 className='text-xl mt-7 sedan-regular text-grey'>
        Revolutionize school management with LearnEase: comprehensive tools for class organization, student administration, and data analysis.
        </h5>
        ...
        <h6 className='text-xl mt-5 sedan-regular'>
          Sign up for LearnEase now and experience the difference firsthand...
        </h6>
        )}
        {currentUser ? (
        <></>
